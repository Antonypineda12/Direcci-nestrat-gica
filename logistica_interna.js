document.addEventListener('DOMContentLoaded', () => {
    ...
    const totalQuestions = 20; // Hay 22 preguntas en el HTML de Logística Interna
    ...
    function updateSummary() {
        ...
        // --- Guardar el porcentaje en localStorage para Logística Interna ---
        localStorage.setItem('logisticaInternaCompliancePercentage', percentage.toFixed(0)); // Guardar como entero
...
downloadPdfBtn.addEventListener('click', async () => {
    ...
    try {
        ...
        doc.save('checklist_logistica_interna.pdf');
    } catch (error) {
