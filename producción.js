document.addEventListener('DOMContentLoaded', () => {
    ...
    const totalQuestions = 20; // Basado en el HTML proporcionado para producción
    ...
    function updateSummary() {
        ...
        // --- Guardar el porcentaje en localStorage para Producción ---
        localStorage.setItem('produccionCompliancePercentage', percentage.toFixed(0)); // Guardar como entero
   ...
   downloadPdfBtn.addEventListener('click', async () => {
    ...
    try {
        ...
        doc.save('checklist_produccion.pdf');
    } catch (error) {
